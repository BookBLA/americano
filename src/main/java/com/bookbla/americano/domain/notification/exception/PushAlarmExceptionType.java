...
public enum PushAlarmExceptionType implements ExceptionType {
    ...
    INVALID_MEMBER_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_05", "멤버 상태가 올바르지 않습니다."),
    NOT_COMPLETED_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_05", "COMPLETED 상태가 아닙니다."),
    NOT_STYLE_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_05", "STYLE 상태가 아닙니다."),
    NOT_APPROVAL_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_05", "STYLE 상태가 아닙니다."),
