...
public enum PushAlarmExceptionType implements ExceptionType {
    ...
    INVALID_MEMBER_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_05", "올바르지 않은 멤버 상태입니다."),
    NOT_COMPLETED_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_06", "COMPLETED 상태입니다."),
    NOT_STYLE_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_07", "STYLE 상태가 아닙니다."),
    NOT_APPROVAL_STATUS(HttpStatus.BAD_REQUEST, "push_alarm_08", "APPROVAL 상태가 아닙니다."),
    INVALID_OWNER(HttpStatus.BAD_REQUEST, "push_alarm-09", "해당 알림의 소유자가 아닙니다."),
    ;
