...
public class MemberController {
    ...
    public ResponseEntity<MemberResponse> createMember(
        ...
        MemberResponse memberProfileResponse = memberService.createMember(memberCreateRequest.getMemberSignUpInformationId(), memberCreateRequest.toMemberProfileDto());
